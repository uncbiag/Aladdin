...
@click.option("--file-name", "--f", help="output file name", default="test")
def main(logdir_or_logfile: str, write_pkl: bool, write_csv: bool, out_dir: str, file_name: str):
    ...
    if event_paths:
        ...
        if write_pkl:
            ...
            out_file = os.path.join(out_dir, file_name + ".pkl")
            print(out_file)
